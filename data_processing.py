...
print()
my_table4 = my_table3.filter(lambda x: x['EU'] == 'yes').filter(lambda x: x['coastline'] == 'no')
# new = my_table4.select(['city', 'temperature'])
min_temp = my_table4.aggregate(lambda x: min(x), 'temperature')
city_min = my_table4.filter(lambda x: x['temperature'] == str(min)).select(['city', 'temperature'])
max_temp = new = my_table4.aggregate(lambda x: max(x), 'temperature')
city_max = my_table4.filter(lambda x: x['temperature'] == str(max)).select(['city', 'temperature'])
