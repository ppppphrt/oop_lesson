cities = [{'city': 'Aalborg', 'country': 'Denmark', 'latitude': '57.03', 'longitude': '9.92', 'temperature': '7.52'},
          {'city': 'Aberdeen', 'country': 'United Kingdom', 'latitude': '57.17', 'longitude': '-2.08',
           'temperature': '8.10'},
          ...
          {'city': 'Amsterdam', 'country': 'Netherlands', 'latitude': '52.35', 'longitude': '4.92',
           'temperature': '8.93'},
          ...
          {'city': 'Belfast', 'country': 'United Kingdom', 'latitude': '54.60', 'longitude': '-5.96',
           'temperature': '8.48'},
          ...
          {'city': 'Bila Tserkva', 'country': 'Ukraine', 'latitude': '49.77', 'longitude': '30.13',
           'temperature': '6.98'},
          {'city': 'Bilbao', 'country': 'Spain', 'latitude': '43.25', 'longitude': '-2.93', 'temperature': '11.41'},
          {'city': 'Birmingham', 'country': 'United Kingdom', 'latitude': '52.47', 'longitude': '-1.92',
           'temperature': '8.81'},
          {'city': 'Blackpool', 'country': 'United Kingdom', 'latitude': '53.83', 'longitude': '-3.05',
           'temperature': '9.15'},
          ...
          {'city': 'Bournemouth', 'country': 'United Kingdom', 'latitude': '50.73', 'longitude': '-1.90',
           'temperature': '9.97'},
          {'city': 'Bradford', 'country': 'United Kingdom', 'latitude': '53.80', 'longitude': '-1.75',
           'temperature': '8.39'},
          ...
          {'city': 'Bratislava', 'country': 'Slovakia', 'latitude': '48.15', 'longitude': '17.12',
           'temperature': '9.65'},
          ...
          {'city': 'Brno', 'country': 'Czech Republic', 'latitude': '49.20', 'longitude': '16.61',
           'temperature': '7.86'},
          {'city': 'Brugge', 'country': 'Belgium', 'latitude': '51.22', 'longitude': '3.23', 'temperature': '9.65'},
          {'city': 'Bucharest', 'country': 'Romania', 'latitude': '44.43', 'longitude': '26.10',
           'temperature': '10.59'},
          ...
          {'city': 'Cambridge', 'country': 'United Kingdom', 'latitude': '52.20', 'longitude': '0.12',
           'temperature': '9.25'},
          ...
          {'city': 'Chernivtsi', 'country': 'Ukraine', 'latitude': '48.31', 'longitude': '25.92',
           'temperature': '7.06'},
          {'city': 'Chisinau', 'country': 'Moldova', 'latitude': '47.01', 'longitude': '28.86', 'temperature': '8.60'},
          {'city': 'Constanta', 'country': 'Romania', 'latitude': '44.20', 'longitude': '28.61',
           'temperature': '11.24'},
          ...
          {'city': 'Dundee', 'country': 'United Kingdom', 'latitude': '56.47', 'longitude': '-3.00',
           'temperature': '6.40'},
          {'city': 'Edinburgh', 'country': 'United Kingdom', 'latitude': '55.95', 'longitude': '-3.22',
           'temperature': '7.43'},
          ...
          {'city': 'Exeter', 'country': 'United Kingdom', 'latitude': '50.70', 'longitude': '-3.53',
           'temperature': '10.14'},
          ...
          {'city': 'Glasgow', 'country': 'United Kingdom', 'latitude': '55.87', 'longitude': '-4.25',
           'temperature': '8.60'},
          ...
          {'city': 'Groningen', 'country': 'Netherlands', 'latitude': '53.22', 'longitude': '6.58',
           'temperature': '8.71'},
          ...
          {'city': 'Ingolstadt', 'country': 'Germany', 'latitude': '48.77', 'longitude': '11.45',
           'temperature': '7.57'},
          {'city': 'Innsbruck', 'country': 'Austria', 'latitude': '47.28', 'longitude': '11.41', 'temperature': '4.54'},
          {'city': 'Inverness', 'country': 'United Kingdom', 'latitude': '57.47', 'longitude': '-4.23',
           'temperature': '8.00'},
          ...
          {'city': 'Klaipeda', 'country': 'Lithuania', 'latitude': '55.72', 'longitude': '21.12',
           'temperature': '7.00'},
          ...
          {'city': 'Kremenchuk', 'country': 'Ukraine', 'latitude': '49.08', 'longitude': '33.43',
           'temperature': '7.43'},
          {'city': 'Kryvyy Rih', 'country': 'Ukraine', 'latitude': '47.93', 'longitude': '33.34',
           'temperature': '8.61'},
          ...
          {'city': 'Ljubljana', 'country': 'Slovenia', 'latitude': '46.06', 'longitude': '14.51',
           'temperature': '9.27'},
          {'city': 'Lvov', 'country': 'Ukraine', 'latitude': '49.83', 'longitude': '24.03', 'temperature': '7.04'},
          {'city': 'Maastricht', 'country': 'Netherlands', 'latitude': '50.85', 'longitude': '5.68',
           'temperature': '8.63'},
          ...
          {'city': 'Montpellier', 'country': 'France', 'latitude': '43.61', 'longitude': '3.87',
           'temperature': '11.11'},
          ...
          {'city': 'Ostrava', 'country': 'Czech Republic', 'latitude': '49.83', 'longitude': '18.25',
           'temperature': '7.66'},
          ...
          {'city': 'Podgorica', 'country': 'Montenegro', 'latitude': '42.47', 'longitude': '19.27',
           'temperature': '9.99'},
          {'city': 'Poznan', 'country': 'Poland', 'latitude': '52.41', 'longitude': '16.90', 'temperature': '8.31'},
          {'city': 'Prague', 'country': 'Czech Republic', 'latitude': '50.08', 'longitude': '14.47',
           'temperature': '8.05'},
          ...
          {'city': 'Sarajevo', 'country': 'Bosnia and Herzegovina', 'latitude': '43.85', 'longitude': '13.38',
           'temperature': '9.60'},
          ...
          {'city': 'Stara Zagora', 'country': 'Bulgaria', 'latitude': '42.42', 'longitude': '25.62',
           'temperature': '10.90'},
          ...
          {'city': 'Swansea', 'country': 'United Kingdom', 'latitude': '51.63', 'longitude': '-3.95',
           'temperature': '9.73'},
          ...
          {'city': 'Yevpatoriya', 'country': 'Ukraine', 'latitude': '45.20', 'longitude': '33.36',
           'temperature': '10.02'},
...
countries = [{'country': 'Albania', 'population': '2.9', 'EU': 'no', 'coastline': 'yes'},
             ...
             {'country': 'Belgium', 'population': '11.37', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Bosnia and Herzegovina', 'population': '3.8', 'EU': 'no', 'coastline': 'yes'},
             ...
             {'country': 'Czech Republic', 'population': '10.55', 'EU': 'yes', 'coastline': 'no'},
             ...
             {'country': 'Germany', 'population': '80.68', 'EU': 'yes', 'coastline': 'yes'},
             ...
             {'country': 'Liechtenstein', 'population': '0.04', 'EU': 'no', 'coastline': 'no'},
             {'country': 'Lithuania', 'population': '2.85', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Luxembourg', 'population': '0.58', 'EU': 'yes', 'coastline': 'no'},
             {'country': 'Macedonia', 'population': '2.08', 'EU': 'no', 'coastline': 'no'},
             {'country': 'Moldova', 'population': '4.06', 'EU': 'no', 'coastline': 'no'},
             {'country': 'Montenegro', 'population': '0.63', 'EU': 'no', 'coastline': 'yes'},
             {'country': 'Netherlands', 'population': '16.98', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Norway', 'population': '5.27', 'EU': 'no', 'coastline': 'yes'},
             {'country': 'Poland', 'population': '38.59', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Portugal', 'population': '10.3', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Romania', 'population': '19.37', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Serbia', 'population': '8.81', 'EU': 'no', 'coastline': 'no'},
             {'country': 'Slovakia', 'population': '5.43', 'EU': 'yes', 'coastline': 'no'},
             {'country': 'Slovenia', 'population': '2.07', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Spain', 'population': '46.06', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Sweden', 'population': '9.85', 'EU': 'yes', 'coastline': 'yes'},
             {'country': 'Switzerland', 'population': '8.38', 'EU': 'no', 'coastline': 'no'},
             {'country': 'Turkey', 'population': '79.62', 'EU': 'no', 'coastline': 'yes'},
             {'country': 'Ukraine', 'population': '44.62', 'EU': 'no', 'coastline': 'yes'},
             {'country': 'United Kingdom', 'population': '65.11', 'EU': 'yes', 'coastline': 'yes'}]
...
class City:
    def __init__(self, data):
        self.name = data['city']
        self.country_name = data['country']
...
class Database:
    ...
    def get_cities(self, **filters):
        ...
        for key, value in filters.items():
            results = [city for city in results if getattr(city, key) == value]
        return results

    def get_country(self, country_name):
        return next((country for country in self.countries if country.name == country_name), None)
...
class Report:
    ...
    def average_temperature(self, country_name):
        cities = self.db.get_cities(country_name=country_name)
        avg_temp = sum([city.temperature for city in cities]) / len(cities)
        return avg_temp

    def cities_below_temperature(self, temp, in_eu):
        results = []
        for city in self.db.cities:
            country = self.db.get_country(city.country_name)
            if country.eu == in_eu and city.temperature < temp:
                results.append(city)
        return results

    def min_max_temperature(self, in_eu, has_coastline):
        cities = [city for city in self.db.cities if
                  self.db.get_country(city.country_name).eu == in_eu and
                  self.db.get_country(city.country_name).coastline == has_coastline]
        temps = [city.temperature for city in cities]
        return min(temps), max(temps)

    def latitude_extremes(self):
        extremes = {}
        for country in self.db.countries:
            cities = self.db.get_cities(country_name=country.name)
            lats = [city.latitude for city in cities]
            if lats:
                extremes[country.name] = {'min_latitude': min(lats), 'max_latitude': max(lats)}
        return extremes
